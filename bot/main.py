...
def main():
    ...
    from bot.handlers.shop import (
        shop_callback, category_callback, product_callback,
        add_variant_to_cart_callback,
    )
    ...
    app.add_handler(CallbackQueryHandler(add_variant_to_cart_callback, pattern=r"^addvar_\d+_\d+$"))
    app.add_handler(CallbackQueryHandler(cart_callback, pattern=r"^cart$"))
    app.add_handler(CallbackQueryHandler(remove_from_cart_callback, pattern=r"^rmcart_\d+_\d+$"))
